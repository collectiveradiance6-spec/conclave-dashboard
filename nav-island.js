...
const SECTIONS = [
  {
    ...
    pages: [
      ...
      {label:'World Hub',    icon:'🌐', href:'/hub',         key:'hub'},
      {label:'ClaveShard Shop', icon:'💎', href:'/shop',     key:'shop'},
    ]
  },
  {
    label: 'SUPPORT',
    pages: [
      {label:'Donate',       icon:'💛', href:'/donate',      key:'donate'},
  ...
  },
  {
    label: 'COMMUNITY',
    pages: [
      {label:'Council',      icon:'👑', href:'/team',        key:'council'},
      {label:'Meet The Team',icon:'👥', href:'/team',        key:'meet'},
      {label:'World Connect',icon:'🌐', href:'/hub',         key:'worldconnect'},
  ...
  },
  {
    label: 'PARTNERS',
    pages: [
      {label:'Nitrado',      icon:'🖥️', href:'/nitrado',     key:'nitrado'},
      {label:'Partners',     icon:'🤝', href:'/promotor',    key:'partners'},
      {label:'Promotors',    icon:'📢', href:'/promotor',    key:'promotors'},
      {label:'Sol Parade',   icon:'🎵', href:'/solparade',   key:'solparade'},
      {label:"Sandy's Gallery", icon:'🎨', href:'/gallery',  key:'gallery'},
    ]
  },
  {
    label: 'INFO',
    pages: [
      {label:'Developers',   icon:'⚙️', href:'/developers',  key:'developers'},
  ...
  },
  {
    label: 'AEGIS',
    pages: [
      {label:'AEGIS AI',     icon:'🤖', href:'/ai',          key:'aegis',  highlight:true},
