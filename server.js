...
// ─── SERVER STATUS ────────────────────────────────────
const SERVERS = [
  { id: "island",     name: "The Island",     ip: "217.114.196.102", port: 5390, mode: "PvE" },
  { id: "volcano",    name: "The Volcano",    ip: "217.114.196.79",  port: 5310, mode: "PvE" },
  { id: "extinction", name: "Extinction",     ip: "31.214.196.102",  port: 6440, mode: "PvE" },
  { id: "center",     name: "The Center",     ip: "31.214.163.71",   port: 5120, mode: "PvE" },
  { id: "lostcolony", name: "Lost Colony",    ip: "217.114.196.104", port: 5150, mode: "PvE" },
  { id: "astraeos",   name: "Astraeos",       ip: "217.114.196.9",   port: 5320, mode: "PvE" },
  { id: "valguero",   name: "Valguero",       ip: "85.190.136.141",  port: 5090, mode: "PvE" },
  { id: "scorched",   name: "Scorched Earth", ip: "217.114.196.103", port: 5240, mode: "PvE" },
  { id: "aberration", name: "Aberration",     ip: "217.114.196.80",  port: 5540, mode: "PvP" },
  { id: "amissa",     name: "Amissa",         ip: "217.114.196.80",  port: 5180, mode: "Donator" },
];
...
const fetchServerStatuses = async () => {
  ...
  await Promise.all(SERVERS.map(async (srv) => {
    try {
      const url = `https://api.battlemetrics.com/servers?filter[search]=${srv.ip}:${srv.port}&filter[game]=ark&fields[server]=name,players,maxPlayers,status`;
      const headers = process.env.BATTLEMETRICS_TOKEN
